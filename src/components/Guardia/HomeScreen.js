    ...
    <View style={styles.container}>
      ...
      <View style={styles.headerContainer}>
        ...
        <TouchableOpacity onPress={logout}>
          <Image source={require('../../images/log-out.png')} style={styles.headerIcon} />
        </TouchableOpacity>
      </View>
      ...
      <Animated.View style={[styles.sideMenu, { left: menuAnimation }]}>
        <View style={styles.profileSection}>
          <Image source={require('../../images/Guardia/profile.png')} style={styles.profileIcon} />
          <Text style={styles.profileName}>Arturo</Text>
        </View>

        <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('ProfileScreen')}>
          <Image source={require('../../images/Guardia/user.png')} style={styles.menuIcon} />
          <Text style={styles.menuText}>Perfil</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('HistoryScreen')}>
          <Image source={require('../../images/Guardia/visita.png')} style={styles.menuIcon} />
      ...
      <Image source={require('../../images/Guardia/visita.png')} style={styles.icon} />

      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('CameraScreen')}>
        <Text style={styles.buttonText}>Gestionar salidas</Text>
      </TouchableOpacity>
      <Image source={require('../../images/Guardia/salida.png')} style={styles.icon} />


      {/* LOGO */}
      <Image source={require('../../images/Guardia/Logo.png')} style={styles.logo} />
    </View>
  );
}
